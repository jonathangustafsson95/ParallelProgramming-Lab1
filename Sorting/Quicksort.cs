...
namespace Sorting
{
    public class Quicksort<T> : ISort<T>
    {
        ...
        //double depth = Math.Log(Environment.ProcessorCount, 2);
        ...
        private int Partition(T[] inputOutput, int start, int end, IComparer<T> comparer)
        {
            ...
            //while (left < right)
            //{
            //    if (comparer.Compare(inputOutput[left], pivot) < 0)
            //    {
            //        left++;
            //        continue;
            //    }
            //    if (comparer.Compare(inputOutput[right], pivot) > 0)
            //    {
            //        right--;
            //        continue;
            //    }
            //    var tmp = inputOutput[left];
            //    inputOutput[left] = inputOutput[right];
            //    inputOutput[right] = tmp;
            //    left++;
            //}
            //return left;
        }
